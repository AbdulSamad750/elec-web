                          ...
                          {products.map((product) => (
                            <div key={product.id} className="group relative border-solid border-2 p-2 border-gray-200">
                              <a href="/product-detail">
                                ...
                                <div>
                                <p className= "text-sm block font-medium txt-gray-400">
                              ${product.price}
                              <h1>original price</h1>
                              </p>
                              <p className= "text-sm block font-medium txt-gray-900">
                              ${Math.round(product.price*(1-products.discountPercentage/100))}
